 <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
     ...
     <div class="d-flex gap-2">
         ...
         <a href="{{ route('schools.subjects.create', $school) }}"
             class="btn btn-dark px-4 py-3 mb-2 d-flex align-items-center gap-2 rounded-3 btn-lg">
             Add Subject
         </a>
     </div>
 </div>
             ...
             <tr class="fw-semibold">
                 ...
                 <td class="text-end">
                     ...
                     <form action="{{ route('schools.subjects.destroy', [$school->id, $subject->id]) }}" method="POST"
                         ...
                         @csrf
                         @method('DELETE')
                         <button type="submit" class="btn btn-light border p-2 rounded-circle" title="Delete">
