        ...
        <div class="app-wrapper flex-column flex-row-fluid">
            ...
            <div class="p-4 bg-white border-2 rounded-4 shadow-lg mb-5 mb-xl-10" style="border-color: #adb5bd;">
                ...
                <div class="p-4 bg-white border rounded-3 mb-5" style="border-color: #dee2e6;">
                    ...
                    <form action="{{ route('states.update', $state->ulid) }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                    ...
                    <dialog id="delete-state-dialog-{{ $state->id }}"
                        ...
                        <form action="{{ route('states.destroy', $state->id) }}" method="POST" style="margin:0;">
                            ...
                            <p style="font-size:16px;">Are you sure you want to delete this state? This action cannot be
                                undone.</p>
