    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            confirmDeleteBtn.addEventListener("click", async function() {
                const idsToDelete = userId ? [userId] : [...document.querySelectorAll(
                    ".select-user:checked")].map(cb => cb.dataset.id);
            ...
            bulkActionBtn.addEventListener("click", function() {
                const selectedIds = [...document.querySelectorAll(".select-user:checked")].map(cb => cb
                    .dataset.id);
