                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control form-control-sm" required value="{{ $user->first_name }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="last_name" class="form-label">Last Name</label>
                                <input type="text" name="last_name" class="form-control form-control-sm" required value="{{ $user->last_name }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" name="email" class="form-control form-control-sm" required value="{{ $user->email }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="student_id" class="form-control form-control-sm" value="{{ $user->student_id }}">
                            </div>
                        </div>
                        <div class="md-6">
                            <div class="form-group">
                                <label for="country_id" class="form-label">Country</label>
                                <input type="number" name="country_id" class="form-control form-control-sm" value="{{ $user->country_id }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="state_id" class="form-label">State</label>
                                <input type="number" name="state_id" class="form-control form-control-sm" value="{{ $user->state_id }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="zipcode" class="form-label">Zipcode</label>
                                <input type="text" name="zipcode" class="form-control form-control-sm" value="{{ $user->zipcode }}">
                            </div>
                        </div> -->
                        <div class="col-6">
                            <div class="form-group">
