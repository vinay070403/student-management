                            ...
                            <div class="col-md-6">
                                <div class="form-group"> <label for="phone" class="form-label">Phone</label>
                                    <div class="input-group"> <select name="phone_code" class="form-select form-select-lg"
                                        ...
                                        </select> <input type="text" name="phone" class="form-control form-control-lg"
                                            required pattern="\d{10}" placeholder="1234567890" maxlength="10"> </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="avatar-wrapper" class="position-relative mt-3 d-inline-block">
                                        @if (!empty($user->avatar))
                                            <img src="{{ Storage::url($user->avatar) }}" id="user-avatar" alt="User Avatar"
                    ...
                    axios.post("{{ route('users.removeAvatar', $user->id) }}", {}, {
                        ...
                        .then(response => {
                            document.getElementById('user-avatar').src =
                                "{{ asset('images/default-avatar1.jpg') }}";
