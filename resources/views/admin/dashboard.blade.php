                        ...
                        <div class="card dashboard-card h-100 border-0 shadow-sm overflow-hidden">
                            <div class="card-body d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold text-primary mb-0">{{ $usersCount }}</h3>
                                    <p class="text-muted small mb-0">Total registered</p>
                                </div>
                                <div
                                    class="bg-gradient-primary rounded-circle p-3 d-flex align-items-center justify-content-center card-icon">
                        ...
                        <div class="card dashboard-card h-100 border-0 shadow-sm overflow-hidden">
                            <div class="card-body d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold text-success mb-0">{{ $schoolsCount }}</h3>
                                    <p class="text-muted small mb-0">Active schools</p>
                                </div>
                                <div
                                    class="bg-gradient-success rounded-circle p-3 d-flex align-items-center justify-content-center card-icon">
                        ...
                        <div class="card dashboard-card h-100 border-0 shadow-sm overflow-hidden">
                            <div class="card-body d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold text-info mb-0">{{ $countriesCount }}</h3>
                                    <p class="text-muted small mb-0">Total countries</p>
                                </div>
                                <div
                                    class="bg-gradient-info rounded-circle p-3 d-flex align-items-center justify-content-center card-icon">
                        ...
                        <div class="card dashboard-card h-100 border-0 shadow-sm overflow-hidden">
                            <div class="card-body d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="fw-bold text-danger mb-0">{{ $statesCount }}</h3>
                                    <p class="text-muted small mb-0">Total states</p>
                                </div>
                                <div
                                    class="bg-gradient-danger rounded-circle p-3 d-flex align-items-center justify-content-center card-icon">
