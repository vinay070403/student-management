                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name"
                                        class="form-control form-control-lg rounded-3 shadow-sm @error('first_name') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name"
                                        class="form-control form-control-lg rounded-3 shadow-sm @error('last_name') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        required placeholder="example@mail.com" value="{{ old('email') }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="phone_code"
                                            class="form-control form-control-lg rounded-3 shadow-sm @error('phone') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="dob"
                                        class="form-control form-control-lg rounded-3 shadow-sm @error('dob') is-invalid @enderror"
                                        value="{{ old('dob') }}">
                                    @error('dob')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
